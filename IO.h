...
/**
* LCD_ClearBottomRow:
* LCD_ClearBottomRow sets the cursor to the starting position, and clears the bottom row of text.
*
* @params: void
* @return: void
*/
...
/**
* LCD_ClearTopRow:
* LCD_ClearTopRow sets the cursor to the starting position, and clears the top row of text.
*
* @params: void
* @return: void
*/
